// Modified 10/07/2014: Addition of "showMenuDelay"
...
(function ($, window, document) {
    ...
    var pluginName = "accessibleMegaMenu",
        defaults = {
            showMenuDelay: 500, // time in MS before the drop down menus show
    ...
    AccessibleMegaMenu.prototype = (function () {
        ...
        _mouseOverHandler = function (event) {
            ...
            eventTarget.addClass(this.settings.hoverClass);

            this.showMenuTimeoutID = setTimeout(function () {
                if (eventTarget.hasClass(this.settings.hoverClass)) {
                    _togglePanel.call(this, event);
                }
            }.bind(this), this.settings.showMenuDelay);
        ...
        _mouseOutHandler = function (event) {
            ...
            clearTimeout(that.showMenuTimeoutID);
